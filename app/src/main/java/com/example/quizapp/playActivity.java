...
public class playActivity extends AppCompatActivity {
    String[] question_list = {"Как называют людей, идущих по улице?",
            "Где должны ездить машины?",
            "Как называется элемент дороги, предназначенный для движения пешеходов:",
            "Где разрешается переходить улицу пешеходам?",
            "Как нужно переходить улицу?",

    };
    String[] choose_list = {"пешеходы","водители","дети",
            "обочина","по тротуару","везде",
            "по дороге","обочина", "обочина","полоса движения",
            "тротуар","на светофоре или по пешеходному переходу","нигде",
            "там, где удобно пешеходу","на светофоре или по пешеходному переходу","медленно идти при этом петь песни",
            "нужно быстро бежать", "спокойным, твердым шагом, держа взрослого за руку", "медленно идти при этом петь песни",

    };
    String[] correct_list = {"пешеходы", "по дороге", "тротуар", "на светофоре или по пешеходному переходу", "спокойным, твердым шагом, держа взрослого за руку"};
                ...
                view -> {
                        if (isclickBtn){
                            ...
                            if(!valueChoose.equals(correct_list[currentQuestion])){
                                Toast.makeText(playActivity.this , "Не првильно",Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(playActivity.this ,  "Вы должны выбрать один из них",Toast.LENGTH_LONG).show();
                        }
                }
        );
    }
